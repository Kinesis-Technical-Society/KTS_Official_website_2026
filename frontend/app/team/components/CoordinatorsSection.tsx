"use client";
import CoordinatorsCarousel from "./CoordinatorsCarousel";
    ...
    <section className="full-bleed border-b border-zinc-900/20 bg-background dark:border-zinc-200/15">
      <div className="mx-auto w-full max-w-7xl px-4 py-16 sm:px-6">
        ...
        <div className="mb-12 flex flex-col gap-4">
          <SectionLabel number="03" label="Junior Builders" />
          <div className="flex items-end justify-between gap-4 flex-wrap">
            <div className="flex flex-col gap-3">
              ...
              <h2 className="font-serif text-4xl leading-tight text-zinc-900 sm:text-5xl dark:text-zinc-100">
                Coordinators - <span className="italic">Mentors.</span>
              </h2>
              <p className="max-w-md text-sm leading-7 text-zinc-600 dark:text-zinc-300">
                Coordinators and mentors are the backbone of KTS.
                They work day in and day out to guide the young minds towards success.
              </p>
            </div>
