  ...
  return (
    ...
    >
      <div className="mx-auto grid w-full max-w-7xl gap-10 px-4 py-14 sm:px-6 lg:grid-cols-[0.8fr_1.9fr]">
        ...
        <div className="grid overflow-hidden border border-zinc-900/20 bg-white/70 sm:grid-cols-2 lg:grid-cols-5 dark:border-zinc-200/15 dark:bg-[#141414]/80">

          {/* Web Development */}
          <div className="flex flex-col gap-4 border-b border-zinc-900/20 p-6 lg:border-r dark:border-zinc-200/15">
            <span className="text-xs font-semibold uppercase tracking-widest text-zinc-400">
              01
            </span>

            <span className="flex h-11 w-11 items-center justify-center rounded-xl border-2 border-zinc-900 bg-(--accent-lime) text-lg font-bold text-zinc-900 shadow-[0_3px_0_#111]">
              🌐
            </span>
          ...
          <div className="flex flex-col gap-4 border-b border-zinc-900/20 p-6 lg:border-r dark:border-zinc-200/15">
            ...
            <span className="flex h-11 w-11 items-center justify-center rounded-xl border-2 border-zinc-900 bg-(--accent-lavender) text-lg font-bold text-zinc-900 shadow-[0_3px_0_#111]">
              🤖
            </span>
          ...
          <div className="flex flex-col gap-4 border-b border-zinc-900/20 p-6 lg:border-r dark:border-zinc-200/15">
            ...
            <span className="flex h-11 w-11 items-center justify-center rounded-xl border-2 border-zinc-900 bg-(--accent-sky) text-lg font-bold text-zinc-900 shadow-[0_3px_0_#111]">
              🎨
            </span>
          ...
          <div className="flex flex-col gap-4 border-b border-zinc-900/20 p-6 lg:border-r dark:border-zinc-200/15">
            ...
            <span className="flex h-11 w-11 items-center justify-center rounded-xl border-2 border-zinc-900 bg-(--accent-amber) text-lg font-bold text-zinc-900 shadow-[0_3px_0_#111]">
              🧩
            </span>
